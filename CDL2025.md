...
subtitle: \footnotesize CDL 2025
author: Yvan Sraka
theme: default
---
...
Use `nix derivation show` to inspect `.drv` files, and `nix why-depends` to trace dependency chains.

## **Demo**

```bash
> nix why-depends /nix/store/fy9cyhdyb32jgvbjs7kwadfnx644dp97-pandoc-cli-3.6 \
